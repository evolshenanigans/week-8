...
const rootSlice = createSlice({
    ...
    initialState: {
        ...
        owners: 'Bunta Fujiwara, Takumi Fujiwara',
        weight: '940kg',
        spec_version: "SPEC. I",
    ...
    reducers: {
        ...
        chooseOwners: (state, action) => { state.owners = action.payload},
...
export const { chooseName, chooseModel, chooseDescription, chooseYear, chooseEngine, chooseMaxSpeed, chooseOwners, chooseWeight, chooseSeries, chooseSpec} = rootSlice.actions